...
|---------|-----------|-----------|---------|
| **AFE-STD-100** | `AFE-STD-100.md` | Ver.0.1-1 | 🔧 策定中（初版ドラフト） |
| **AFE-STD-101** | `AFE-STD-101.md` | Ver.0.1-1 | 🔧 策定中（初版ドラフト） |
| **AFE-STD-102** | `AFE-STD-102.md` | Ver.0.1-1 | 🔧 策定中（初版ドラフト） |
...
| コア標準 | AFE-STD-100（命名規則）ドラフト作成 | 🔧 策定中 | 初版ドラフト完成 |
| コア標準 | AFE-STD-101（オートローディング）ドラフト作成 | 🔧 策定中 | 初版ドラフト完成 |
| コア標準 | AFE-STD-102（コーディングスタイル）ドラフト作成 | 🔧 策定中 | 初版ドラフト完成 |
...
| フェーズ | 内容 | 時期 | ステータス |
|---|---|---|---|
| **Phase 0** | プロジェクト立ち上げ・AFE-STD-100 初版ドラフト | 2026 Q1 | 🔧 策定中 |
